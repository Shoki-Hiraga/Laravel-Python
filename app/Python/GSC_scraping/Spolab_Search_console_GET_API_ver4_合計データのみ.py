...
file_name = "Spolab_Search Console_API_URL.csv"
...
# 対象のサイトURLを指定します
site_url = 'https://www.sportscar-lab.com/'

# JSONファイルのパスを指定
SERVICE_ACCOUNT_FILE = api_json.spolab_gsc
...
try:
    with open(output_file, 'w', newline='', encoding='utf-8') as csvfile:
        ...
        # 個別URLリストインスタンス
        from setting_file.Search_Console_set.Spolab_url import URLS
        for url in URLS:
            # URLの統計情報を取得
